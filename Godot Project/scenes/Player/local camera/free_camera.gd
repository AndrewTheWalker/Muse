...
func Exit():
	...
	var rotation_to_align = Quaternion(offset_direction.normalized(),locked_camera.offset.normalized())
	locked_camera.offset = locked_camera.offset * rotation_to_align
